%
% m-file that generates Figure 5.5 of the PhD thesis:
...
[area5, L5] = invert(fmt',M,10,'fourier0');
area5 = area5';
...
set(gca,'xtick',0:5:20,...
        'ytick',0:0.1:0.2,...
	'ztick',0:5:10);
text('position',[18 0 8],'string','Fourier (Odd Terms)','fontsize',12,...
...
F = fmt/1000;
F5 = area2fmt(area5,L5',3)/1000;
t = 0.01:0.02:0.19;
max_diff5 = max(abs(100*(F5 - F)./F));
if v >= 5
  plot(t,F5(:,1),'k-',t,F5(:,2),'k-',t,F5(:,3),'k-');
else
  plot(t,F5(:,1),'w-',t,F5(:,2),'w-',t,F5(:,3),'w-');
end
hold on
...
text('position',[0.195,0.7],...
	'string',['F1: ',num2str(max_diff5(1),2),'%'],...
	'HorizontalAlignment','right','fontsize',10)
text('position',[0.195,1.2],...
	'string',['Max. Diff. F2: ',num2str(max_diff5(2),2),'%'],...
	'HorizontalAlignment','right','fontsize',10)
text('position',[0.195,1.7],...
	'string',['F3: ',num2str(max_diff5(3),2),'%'],...
	'HorizontalAlignment','right','fontsize',10)
