%
% m-file that generates Figure 5.4 of the PhD thesis:
...
set(gca,'xtick',0:5:20,...
        'ytick',0:0.1:0.2,...
	'ztick',0:5:10);
text('position',[18 0 6],'string','Principal Components','fontsize',12,...
...
F = fmt/1000;
F3 = area2fmt(area3,L3',3)/1000;
t = 0.01:0.02:0.19;
max_difF3 = max(abs(100*(F3 - F)./F));
if v >= 5
  plot(t,F3(:,1),'k-',t,F3(:,2),'k-',t,F3(:,3),'k-');
else
  plot(t,F3(:,1),'w-',t,F3(:,2),'w-',t,F3(:,3),'w-');
end  
hold on
...
text('position',[0.195,0.7],...
	'string',['F1: ',num2str(max_difF3(1),2),'%'],...
	'HorizontalAlignment','right','fontsize',10)
text('position',[0.195,1.2],...
	'string',['Max. Diff. F2: ',num2str(max_difF3(2),2),'%'],...
	'HorizontalAlignment','right','fontsize',10)
text('position',[0.195,1.7],...
	'string',['F3: ',num2str(max_difF3(3),2),'%'],...
	'HorizontalAlignment','right','fontsize',10)
